...
This simulator provides mock/simulated AIS-messages to the UVMS application backend. The AIS simulator server is made up of a browser/HTML frontend and a J2EE/REST backend.
